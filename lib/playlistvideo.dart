...
// Widget baru untuk menampilkan video dalam WebView di halaman terpisah
...
class _VideoPlayerPageState extends State<VideoPlayerPage> {
        ...
        return Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: Container(
              ...
              color: Colors.black.withOpacity(0.45), // sudut kotak
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  // Tombol Back — hanya ini yang tumpul
                  Container(
                    height: 40,
                    width: 40,
                    decoration: BoxDecoration(
                      color: Colors.white.withOpacity(0.12),
                      borderRadius: BorderRadius.circular(10), // hanya ini yang tumpul
                    ),
                    child: IconButton(
  ...
  Widget _buildPlaylistView() {
    // Filter video yang sedang diputar dari daftar
...
class _PlaylistVideoListPageState extends State<PlaylistVideoListPage> {
  ...
  bool isLoading = true;
  // Hapus state untuk YoutubePlayerController
  ...
  Future<void> fetchPlaylistVideos() async {
    ...
    try {
          ...
          if (data['items'] != null) {
            allVideos.addAll(
              List<Map<String, dynamic>>.from(data['items'].map((item) {
                // Pastikan thumbnail ada sebelum diakses
      ...
      setState(() {
        // Hapus logika untuk inisialisasi player
            ...
            child: isLoading
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    // Ubah onTap untuk navigasi ke halaman WebView
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
