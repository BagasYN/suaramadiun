...
class _PlaylistPageState extends State<PlaylistPage>
  ...
  @override
  bool get wantKeepAlive => false; // biar rebuild setiap kali balik ke tab
  ...
  void initState() {
    ...
    // Gunakan mounted check di timer agar aman
    _timer = Timer.periodic(const Duration(seconds: 40), (_) {
      if (mounted) fetchFirebaseAndPlaylists();
    });
  }
